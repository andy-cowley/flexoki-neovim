...
M.groups = function()
  ...
  return {
    ...
    ["Constant"] = { fg = c["cy"], bg = "NONE" },
    ["String"] = { fg = c["gr"], bg = "NONE" },
    ["Character"] = { fg = c["or"], bg = "NONE" },
    ["Number"] = { fg = c["or"], bg = "NONE" },
    ...
    ["Include"] = { fg = c["ma"], bg = "NONE" },
    ["Define"] = { fg = c["ma"], bg = "NONE" },
    ["Macro"] = { fg = c["re"], bg = "NONE" },
    ["PreCondit"] = { fg = c["ma"], bg = "NONE" },

    ["Type"] = { fg = c["ye"], bg = "NONE" },
    ["StorageClass"] = { link = "Type" },
    ["Structure"] = { link = "Type" },
    ["Typedef"] = { link = "Type" },

    ["SpecialComment"] = { link = "Comment" },
    ["Special"] = { fg = c["re"], bg = "NONE" },
    ["SpecialChar"] = { fg = c["re"], bg = "NONE" },
    ["Tag"] = { fg = c["gr"], bg = "NONE" },
    ["Debug"] = { fg = c["ma"], bg = "NONE" },
    ["Delimiter"] = { fg = c["tx-3"], bg = "NONE" },
    ["Error"] = { fg = c["re"], bg = c["bg"], bold = true },
    ["Todo"] = { fg = c["pu"], bg = "NONE", bold = true },
    ["Warning"] = { fg = c["ye"], bg = "NONE", bold = true },
    ["Note"] = { fg = c["bl"], bg = "NONE", bold = true },
